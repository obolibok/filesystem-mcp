...
Подготовить карточку 002: проверка доставки оригиналов в целевую среду анализа
до реализации `snapshot` и `bundle`. Зависимость от 001 выполнена; 002 пока
не назначена и остаётся направлением для планирования.
