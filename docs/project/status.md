...
| 002 | [Доставка originals в среду анализа](../tasks/002-originals-delivery.md) | ready    | 001        | Карточка готова; назначение отдельной рабочей задаче       |
...
Запустить 002 в отдельном worktree на GPT-5.6-Sol с effort Extra High.
Карточка и критерии готовы: проверить фактическую доставку ZIP/XLS и открытие
файлов в целевой среде анализа до реализации `snapshot` и `bundle`.
