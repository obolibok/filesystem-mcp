...
[Стенд живого опыта](../testing/006-live-2026-09-24.md) подготовлен: 13 portable checks PASS; туннель запущен, первый ChatGPT smoke PASS; следующий шаг — ready reuse из второго чата.
