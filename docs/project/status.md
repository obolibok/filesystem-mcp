...
| 002-live | [Windows и ChatGPT: пошаговый живой прогон](../tasks/002-live-windows-chatgpt.md) | ready    | 002           | Отдельная задача с пользователем; GPT-5.6-Sol / Extra High                            |
...
Запустить 002-live: пользователь ожидает последовательное сопровождение установки
