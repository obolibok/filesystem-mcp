...
| 008          | [Надёжность job metadata на Windows](../tasks/008-job-metadata-persistence.md)      | review   | 007 runtime       | Review 7bf58e05 PASS; новая тестовая поставка готова, далее большой live                                                          |
