...
Отрицательные fixtures для второго entry, неверного CRC, усечения и повреждённых
compressed bytes входят в regression suite.
...
| -------------- | --------: | ------------: | -----------: | ----: | --------: | ------------: | -----------: | -----------: |
| pipeline-small |   100 000 |  15 788 947 B |  1 698 026 B |     1 |   4,041 s | 138 436 608 B | 42 067 792 B | 17 379 360 B |
| pipeline-large | 3 000 000 | 478 889 517 B | 50 373 149 B |    11 | 173,841 s | 238 374 912 B | 76 753 088 B | 96 829 298 B |
...
peak RSS в 1,72 раза, heap в 1,82 раза; память не растёт пропорционально числу строк.
