...
материализованы в ChatGPT; на момент постановки передача больших частей ещё
не была доказана. Последующий [live опыт](../testing/003-live-2026-09-20.md)
проверил smoke/main/upper; итог приёмки записан в конце карточки.
...
- [x] После локальной готовности — synthetic live ChatGPT прогон с пользователем:
...
### Приёмка планированием и подготовка интеграции, 2026-09-20

- Проверенный runtime head: `9ff207922b55d040608590323e025fd45eb29634`.
  [Локальное review](../testing/003-review-r3-2026-09-20.md): R1–R8 закрыты;
  независимый полный check без dependency workaround — 380 tests, 373 pass,
  0 fail, 7 прежних Windows skips.
- [Живой ChatGPT опыт](../testing/003-live-2026-09-20.md): smoke/main/upper PASS.
  Все части получены, SHA-256/CRC/CSV и полные эталоны совпали; повторная доставка
  больших частей побайтово идентична. Максимальный проверенный ZIP — 7802264 B;
  полный wire size и верхний предел host не установлены.
- Исторические pending в Work record выше описывают прежние этапы. Функциональные
