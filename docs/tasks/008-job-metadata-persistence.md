...
Статус/назначение: [доска](../project/status.md). Предложена по результатам live 007;
исполнитель пока не назначен. Планируемая модель GPT-6-Sol / Extra High.
Зависимость: runtime 007 `832a6771cd3938947c24329b6d06a512bf5605db`.
Перед запуском планирование готовит committed base с этим runtime и карточкой.
...
кодирование и новый чат пока не назначены.
