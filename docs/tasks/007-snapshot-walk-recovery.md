...
Подготовлена планированием 25.09.2026; реализация ещё не запущена.
Предлагаемый исполнитель: GPT-6-Sol / Extra High, отдельный worktree,
ветка codex/007-snapshot-walk-recovery. Новый чат пока не создан.
